...
public class Email {
    ...
    public void SendMessage(String errorMessage,Exception exception) {
        ...
        try {
            ...
            attachment.attachFile(new File("C:\\LP\\ПП\\Lab4-8\\ComplexLab\\ErrorDetail.txt"));
            MimeBodyPart attachment2 = new MimeBodyPart();
            attachment2.attachFile(new File("C:\\LP\\ПП\\Lab4-8\\ComplexLab\\LogFile\\compressedLogFile.zip"));
    ...
    private void generateFileWithExeption(Exception e) throws IOException {
    ...
    private void compressLogFile() throws IOException {
        String sourceFile = "C:\\LP\\ПП\\Lab4-8\\ComplexLab\\LogFile\\Logger.log";
        FileOutputStream fos = new FileOutputStream("C:\\LP\\ПП\\Lab4-8\\ComplexLab\\LogFile\\" +
